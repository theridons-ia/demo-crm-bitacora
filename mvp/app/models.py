...
class Product(Base):
    ...
    presentation: Mapped[str | None] = mapped_column(String(80), nullable=True)
    ...
    min_stock: Mapped[int] = mapped_column(Integer, default=40)
...
class Visit(Base):
    ...
    end_gps_accuracy_m: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    end_gps_captured_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
